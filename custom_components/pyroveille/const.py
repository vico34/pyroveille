...
DEFAULT_AIRCRAFT_SCAN_INTERVAL = timedelta(seconds=10)
DEFAULT_ADSB_AIRCRAFT_SCAN_INTERVAL = timedelta(seconds=60)
DEFAULT_ADSB_SEARCH_RADIUS_KM = 300.0
...
DEFAULT_ENABLE_AIRCRAFT_TRACKING = True
DEFAULT_ENTITY_RETENTION_HOURS = 24.0
...
CONF_ENABLE_AIRCRAFT_TRACKING = "enable_aircraft_tracking"
CONF_ENTITY_RETENTION_HOURS = "entity_retention_hours"
